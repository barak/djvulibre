...
LangString DESC_Quick ${LANG_SPANISH} "Crear acceso directo de DjView en la barra de inicio rápido para el usuario actual"
...
LangString secQuick ${LANG_SPANISH} "Crear acceso directo en la barra de inicio rápido"
...
LangString WebDL_LNK ${LANG_SPANISH}  "página de descarga"
LangString Doc_LNK ${LANG_SPANISH} "Documentación"
LangString Lic_TXT ${LANG_SPANISH} "Licencia"
LangString Uninst_MSG ${LANG_SPANISH} "¿Está seguro de que desea eliminar por completo $(^Name) y todos sus componentes?"
...
LangString Message_AlreadyInstalled ${LANG_SPANISH} "${PRODUCT_NAME} ${PRODUCT_VERSION} ya está instalado. Desinstalar?"
